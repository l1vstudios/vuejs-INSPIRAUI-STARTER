...
<template>
  <nav class="fixed top-0 left-0 w-full bg-black/80 backdrop-blur-md text-white shadow-md z-50">
    ...
    <!-- Mobile Menu -->
    <div v-if="menuOpen" class="md:hidden px-4 pb-3 space-y-2 bg-black/90">
